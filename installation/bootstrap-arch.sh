...
install_script 'development tools' "${script_dir}/arch/development-tools.sh"
...
install_script 'applications' "${script_dir}/arch/applications.sh"

echo '######################'
echo 'Ready setting up arch!'
